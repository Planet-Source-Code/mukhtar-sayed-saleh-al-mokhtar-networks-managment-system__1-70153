...
Begin VB.Form FrmSetting 
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VB.Frame Frame4 
         ...
         Begin ACTIVESKINLibCtl.SkinLabel SkinLabel5 
            Height          =   255
            Left            =   2640
            OleObjectBlob   =   "FrmSetting.frx":29CA2
            TabIndex        =   23
            Top             =   1080
            Width           =   1815
         End
         ...
         Begin ACTIVESKINLibCtl.SkinLabel SkinLabel4 
            Height          =   255
            Left            =   2760
            OleObjectBlob   =   "FrmSetting.frx":29D26
            TabIndex        =   21
            Top             =   600
            Width           =   1695
         End
         ...
         Begin ACTIVESKINLibCtl.SkinLabel SkinLabel3 
            Height          =   255
            Left            =   120
            OleObjectBlob   =   "FrmSetting.frx":29DAA
            TabIndex        =   19
            Top             =   120
            Width           =   4335
         End
   ...
   Begin ACTIVESKINLibCtl.Skin Skin1 
      Left            =   3600
      OleObjectBlob   =   "FrmSetting.frx":29E27
      Top             =   2760
   End
   ...
   Begin VB.Frame Frame2 
      ...
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel1 
         Height          =   255
         Left            =   6480
         OleObjectBlob   =   "FrmSetting.frx":2A05B
         TabIndex        =   9
         Top             =   360
         Width           =   975
      End
      ...
      Begin ACTIVESKINLibCtl.SkinLabel SkinLabel2 
         Height          =   255
         Left            =   6480
         OleObjectBlob   =   "FrmSetting.frx":2A0CD
         TabIndex        =   11
         Top             =   840
         Width           =   975
      End
...
MsgBox "«·—Ã«¡ ≈œŒ«· ﬁÌ„… ”⁄— «·”«⁄…", 16, "‰Ÿ«„ «·„Œ «—"
Exit Sub
End If
If IsNumeric(Text1.Text) = False Then
MsgBox "≈‰ «· ⁄»Ì— «·–Ì ›Ì Õﬁ· ”⁄— «·”«⁄… ·Ì” —ﬁ„«", 16, "‰Ÿ«„ «·„Œ «—"
Exit Sub
End If
...
MsgBox "«·—Ã«¡ «· √ﬂœ „‰  ⁄»∆… Ã„Ì⁄ «·ÕﬁÊ· «·„ÿ·Ê»…", 16, "‰Ÿ«„ «·„Œ «—"
Exit Sub
End If

If Text9.Text <> Text10.Text Then
MsgBox "ﬂ·„… «·„—Ê— «·ÃœÌœ… Ê  √ﬂÌœÂ« €Ì— „ ÿ«»ﬁÌ‰", 16, "‰Ÿ«„ «·„Œ «—"
Exit Sub
End If
...
If .txtaname.Text = vadmin Then
   If .txtapass.Text = vpass Then
    ...
    .Data1.Recordset.MoveNext
    .Data1.Recordset.MovePrevious
    MsgBox " „  €ÌÌ— ﬂ·„… «·„—Ê— »‰Ã«Õ", 64, "‰Ÿ«„ «·„Œ «—"
   Else
    MsgBox "ﬂ·„… «·„—Ê— «·ﬁœÌ„… Œ«ÿ∆…", 16, "›‘·  ”ÃÌ· «·œŒÊ·"
   End If
End If
End With
On Error Resume Next
